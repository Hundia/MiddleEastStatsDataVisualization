              ...
              <div class="timeline timeline-1">
                <div data-time="1881">
                  <div class="timeline-visual">
                    <img src="img/ataturk/ataturk-4.jpg" alt="">
                  </div>
                  <div class="timeline-detail">
										<ul class="timeline-detail-list">
											<li>Birth of Mustafa Kemal Ataturk to Ali Riza and Zübeyde at Salonika.</li>
										</ul>
                  </div>
                </div>
								<div data-time="1883">
									<div class="timeline-visual">
										<img src="img/ataturk/ataturk-2.jpg" alt="">
									</div>
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
								...
								<div data-time="1893">
									<div class="timeline-visual">
										<img src="img/ataturk/ataturk-3.jpg" alt="">
									</div>
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
								...
								<div data-time="1895">
									<div class="timeline-visual">
										<img src="img/ataturk/ataturk-11.jpg" alt="">
									</div>
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
								...
								<div data-time="1896">
									<div class="timeline-visual">
										<img src="img/ataturk/ataturk-5.jpg" alt="">
									</div>
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
								...
								<div data-time="1897">
									<div class="timeline-visual">
										<img src="img/ataturk/ataturk-6.jpg" alt="">
									</div>
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
								...
								<div data-time="1898">
									<div class="timeline-visual">
										<img src="img/ataturk/ataturk-10.jpg" alt="">
									</div>
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
								...
								<div data-time="1907">
									<div class="timeline-visual">
										<img src="img/ataturk/ataturk-9.jpg" alt="">
									</div>
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
								...
								<div data-time="1908">
									<div class="timeline-visual">
										<img src="img/ataturk/ataturk-8.jpg" alt="">
									</div>
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
								...
								<div data-time="1913">
									...
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
											...
											<li>27 October. Mustafa Kemal appointed Military Attaché in Sofia.</li>
										</ul>
									</div>
								</div>
								<div data-time="1914">
								...
								<div data-time="1916">
									...
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
											...
											<li>6 - 7 August. Mustafa Kemal recaptures Bitlis and Muş from Russians.</li>
										</ul>
									</div>
								</div>
								<div data-time="1917">
								...
								<div data-time="1918">
									<div class="timeline-visual">
										<img src="img/ataturk/ataturk-7.jpg" alt="">
									</div>
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
								...
								<div data-time="1920">
									...
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
											...
											<li>9 February. Evacuation of French garrison from Maraş and start of general withdrawal from Cilicia.</li>
											...
											<li>3 December. Treaty of Gümrü settles Turco-Armenian frontiers.</li>
										</ul>
									</div>
								</div>
								<div data-time="1921">
									...
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
											...
											<li>10 July. Greeks resume offensive and capture Eskişehir.</li>
											...
											<li>19 September. Mustafa Kemal given title of “Gazi”and rank of Marshal by Grand National Assembly.</li>
								...
								<div data-time="1934">
									...
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
											...
											<li>24 November. Mustafa Kemal adopts the surname "ATATÜRK" which is given to him by the Turkish Parliament.</li>
								...
								<div data-time="1938">
									<div class="timeline-visual">
										<img src="img/ataturk/ataturk-1938.jpg" alt="">
									</div>
									<div class="timeline-detail">
										<ul class="timeline-detail-list">
											...
											<li>10 November. The death of Mustafa Kemal “Ataturk,” the leader of the Turkish War of Independence and founder of modern-day Turkey.</li>
